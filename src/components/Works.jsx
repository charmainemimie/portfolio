    ...
    <div className="border border-radius-12 flex flex-wrap justify-between pb-3">
      {works.map((item) => {
        return (
          ...
          text-white focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"  rel="noreferrer"
          ...
          >
            <a href={item.link}
            target="_blank"
            className="text-white focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 mt-4 text-center"  rel="noreferrer"
          >
