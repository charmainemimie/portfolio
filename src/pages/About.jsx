    ...
    <div className=" pt-4">
      ...
      <div className="flex justify-end lg:w-1/2 ml-auto text-left pb-12">
        <div className="flex-item">
          ...
          development. I also have knowledge in network and computer security. I
          am a quick learner, an analytical thinker, and a problem-solver. I
          enjoy working collaboratively with others to solve complex problems,
          and I am always looking for new challenges to expand my skill set. In
          my free time, I enjoy tinkering with personal programming projects and
          staying up-to-date with the latest industry trends. Thank you for
          taking the time to learn more about me. Please feel free to explore my
